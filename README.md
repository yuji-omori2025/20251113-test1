...
<header>
  <a href="index.html" class="team logo.png"> <img src="team logo.svg" alt="swim experience のロゴ">
  </a>
</header>

<section class="hero">
  <div class="hero-content"> <h2> Life is tough, keep swimming.</h2>
    <small>人生は常に大変だ。でも水泳は速く美しく泳ぎたい</small>
  </div>
      ...
      <div class="list-normal3-parts">
        ...
        <div class="list-parts">
          ...
          <div class="text-parts">
            ...
            を理念として、競泳、スポーツを愛しているが、悩みある選手たちに、<br>
        ...
        <div class="list-parts">
          ...
          <div class="text-parts">
            ...
            <p>レースでは、一緒のタイミングでスタートしているのに、なんであんなに差が付いてしまうのか？</p>
            <p>私は、いつ、どのタイミングで、１番タイムが伸びるのだろうか？</p>
            <p>今以上、これ以上タイムが縮まらない、伸びないのか？</p>
...
　　　　<div class="list-parts"> <div class="text-parts"> <p><strong>宇都宮スイムマスターズ連合について</strong></p>
            <p>マスターズ会員や個人の選手で、「練習拠点や指導者、練習内容、スタート練習」などに課題や</p>      
            <p>お悩みのお持ちの方がいらっしゃるとお声掛けいただき</p>
            <p>➡水泳に関するお悩みを解決に導く<strong>マッチングハブ機能が必要</strong></p>
            <p>との考えから、2026年から発足を行います。</p>
            <p>ご興味のある選手、チーム代表の方は、ぜひご相談ください</p>
            <p>スイム・イクスピリエンスの活動情報は、インスタグラムで閲覧可能です【後日、インスタＱＲを載せる】</p>
            <div class="button_solid002">
              <a href="#" class="button">
                加入、ご相談のある選手、チーム代表はクリック
        ...
        <div class="list-parts">
          ...
          <div class="text-parts">
            ...
            <p>たまたま行ったプールで、バタフライジジイ（詳細は、次の事項をご確認ください）</p>
            <p>に出会い、泳ぐうちに、水泳の楽しさに目覚め、導かれる。</p>
            <p>導かれてからは、泳ぐ力と速さが上がっていることを実感出来ているが</p>
            <p>いざレースになると自分をコントロールしきれず、いまだ結果には結びついていない。</p>
            <p>また、バタジイに導かれた影響なのかは不明だが、きちんと着用して泳いでも</p>
　　　　　　<p>泳ぎ終わるとゴーグルが吊り上がるようになった。</p>
            <p>(後ほど画像差し込み)</p>
        ...
        <div class="list-parts">
          ...
          <div class="text-parts">
            ...
            （ある情報筋から入手した、バタフライジジイの手配書）</p>
            <p>主に芳賀町で目撃例が多いが、栃木県以外でも、埼玉県や東京都のプールに出没したとの情報がある。</p>
            <p>子どもと、スポーツに真剣に向き合っている人には優しいとの情報もあるが、バタジイへのリスペクトを行わず、逆に攻撃したり、身の程を知らないオトナ相手には、
            バタジイのバタフライアームで、練習しているフリをして、首にラリアート攻撃をしてくるとの噂がある。
            もし遭遇したら、不用意に近寄らず、水面を荒らさずに後ろ向きの状態でプールやレーンから離れるのが命を守る方法と言われる。</p>
            <p>好きなものは、清らかな心を持つ子どもと、上三川町のらー麺 藤原家のつけ麺、抹茶スイーツ全般で、藤原家と、和菓子茶屋 武平作と、プール以外の場でも多数の出没情報もある。
            基本、バタフライを速く泳ぐことに全勢力を注いでいる妖怪のため、プール以外で遭遇できるのはレア。また遭遇した人間には幸せが訪れるという幸運の妖怪でもある。（民明書房刊）</p>
...
　　　　 <p>メールアドレス:<input type="email" name="email" required></p>
         <p>依頼される項目<①競泳選手傾向診断----------②レース動画解析---------〇スイマー体型お悩み-------〇宇都宮スイムマスターズ連合の活動について-></p>
　　　　 <p>具体的な悩みごと</p>
